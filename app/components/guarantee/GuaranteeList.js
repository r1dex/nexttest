        ...
        <section className={Styles.guarantees}>
            ...
            <div className={Styles.guarantees}>
                <div className={Styles.guarantee}>
                    ...
                    <Image src={'/images/guarantees/1.jpg'} alt={'1'} width={300} height={300}/>
                </div>
                <div className={Styles.guarantee}>
                    <div>Собственное производство в Санкт-Петербурге</div>
                    <Image src={'/images/guarantees/2.jpg'} alt={'1'} width={300} height={300}/>
                </div>
                <div className={Styles.guarantee}>
                    <div>Опытные мастера с опытом работы с зеркалами и стеклами более 5 лет</div>
                    <Image src={'/images/guarantees/3.jpg'} alt={'1'} width={300} height={300}/>
                </div>
                <div className={Styles.guarantee}>
                    <div>Собственная многоуровневая система контроля качества</div>
                    <Image src={'/images/guarantees/4.jpg'} alt={'1'} width={300} height={300}/>
                </div>
            </div>
        </section>
    )
